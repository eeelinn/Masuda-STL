//To be called by Count_NP_Cells.ijm macro by Erikka Linn
//make sure to select the image to process/count

	imageTitle = getTitle();

//User chooses state of cells (punctured vs non-punctured affects the cell staining size)
...
//Final Touches
	...
	run("Analyze Particles...", "size=16-170 show=Masks display summarize");
